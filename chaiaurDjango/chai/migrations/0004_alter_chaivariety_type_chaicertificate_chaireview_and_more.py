...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('chai', '0003_chaivariety_description_alter_chaivariety_type'),
    ...
    operations = [
        migrations.AlterField(
            ...
            name='type',
            field=models.CharField(choices=[('ML', 'MASALA'), ('GR', 'GINGER'), ('PL', 'PLAIN'), ('EL', 'ELAICHI'), ('KL', 'KIWI')], default='PL', max_length=2),
        ),
